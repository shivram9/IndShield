...
This Code of Conduct is adapted from the [Contributor Covenant (v3.000)](https://www.contributor-covenant.org/version/3/0/code_of_conduct/), with modifications tailored for **IndShield under the GirlScript Summer of Code (GSSoC’25)**.  
